import { type Component, createSignal, For, type JSX, onMount, Show, splitProps } from "solid-js";
import { IconClose } from "../../icons/icon-close";
import styles from "./index.module.css";

export type MultiStringProps = Omit<JSX.HTMLAttributes<HTMLInputElement>, "value"> & {
  name?: string;
  value?: string[];
};
...
export const MultiString: Component<MultiStringProps> = (props) => {
  ...
  const handleOnInput: JSX.InputEventHandlerUnion<HTMLInputElement, InputEvent> = (e) => {
