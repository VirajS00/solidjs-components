import { type Component, createSignal, Index, type JSX, onMount, splitProps } from "solid-js";
...
export const MultiValueInput: Component<Props> = (props) => {
  const [local, rest] = splitProps(props, ["class", "value", "ref", "placeholder"]);
  ...
  return (
    <div>
      ...
      <Button type="button" variant="outline" color="monochrome" class={styles.addBtn} onClick={handleAddNewItem}>
        <IconPlus /> Add Item
      </Button>
      <input
        type="text"
