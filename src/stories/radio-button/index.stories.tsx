...
const ExampleStory = () => {
  ...
  onMount(() => {
    const inputs: NodeListOf<HTMLInputElement> | undefined = formRef?.querySelectorAll(
      'input[type="radio"][name="my-item"]',
    );
  ...
  return (
    <form style={{ display: "flex", "flex-direction": "column", gap: "0.5rem" }} ref={formRef}>
