...
const ExampleStory = () => {
  ...
  return (
    <form style={{ display: "flex", gap: "0.25em", "flex-direction": "column" }}>
      <Label for="my-combobox" style={{ "padding-left": "0.5em" }}>
        Favorite Music Artist
      </Label>
      <Combobox options={options} label="jokes" id="my-combobox" placeholder="enter values to search" ref={inputRef} />
      <input type="reset" />
    </form>
  );
};
